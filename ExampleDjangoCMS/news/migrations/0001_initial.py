...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('news_news', (
            ...
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 7, 29, 16, 32, 11, 265356))),
        ...
        db.send_create_signal('news', ['LatestNewsPlugin'])
    ...
    models = {
        ...
        'news.news': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 29, 16, 32, 11, 265356)'}),
