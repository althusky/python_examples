...
class News(models.Model):
    ...
    image           = models.ImageField(_('Picture'), blank=True, null=True, upload_to='images/news/')
    ...
    meta_description = models.TextField(u'Мета описание', max_length=255, blank=True)
